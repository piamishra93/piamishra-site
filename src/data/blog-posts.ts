export const blogPosts = [
  {
    ...
    content: `
      ...
      <ul>
        ...
        <li>The bulbs are also one of the few products in the market that elegantly blend together physical and digital worlds.
        The mobile app mimics the bulbs — functional, simple, and well integrated into the ecosystem they are a part of.</li>
      </ul>
    `
  },
  {
  ...
  },
  {
    ...
    excerpt: "An acknowledgement of the places we travel through",
    date: "April 6, 2025",
    readTime: 6,
    image: "/placeholder.svg",
    categories: ["Productivity", "Technology", "UX", "Design", "AI"]
  },
  {
    ...
    excerpt: "Exploring a philosophical approach to internet utilities",
    date: "March 22, 2025",
    readTime: 8,
    image: "/placeholder.svg",
    categories: ["Productivity", "Technology", "UX", "Design", "AI"]
